...
window.__ENV__ = {
  ...
  VITE_EXPORT_EXCEL_ENABLED: "${VITE_EXPORT_EXCEL_ENABLED:-true}",
  VITE_EXPORT_PDF_ENABLED: "${VITE_EXPORT_PDF_ENABLED:-true}",
  VITE_EXPORT_TIFF_ENABLED: "${VITE_EXPORT_TIFF_ENABLED:-true}",
  VITE_EXPORT_DIP_ENABLED: "${VITE_EXPORT_DIP_ENABLED:-true}",
};
EOF
