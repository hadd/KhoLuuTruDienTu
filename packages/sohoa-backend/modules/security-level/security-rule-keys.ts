...
export const SYSTEM_PERMISSION_DEFS = [
    ...
    { key: "download", name: "Tải tài liệu", description: "Cho phép tải file (không watermark)", isSystem: true },
    { key: "download_watermark", name: "Watermark tài liệu", description: "Cho phép tải bản có đóng dấu watermark", isSystem: true },
