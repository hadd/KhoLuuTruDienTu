...
const FIELD_CANONICAL_NAME_BY_SLUG: Record<string, string> = {
    ...
    SO_TAI_LIEU: "TONG_SO_TAI_LIEU_TRONG_HO_SO",
    SO_TAI_LIEU_TRONG_HO_SO: "TONG_SO_TAI_LIEU_TRONG_HO_SO",
    TONG_SO_TAI_LIEU: "TONG_SO_TAI_LIEU_TRONG_HO_SO",
    TONG_SO_TAI_LIEU_TRONG_HO_SO: "TONG_SO_TAI_LIEU_TRONG_HO_SO",
    TONG_SO_VAN_BAN: "TONG_SO_VAN_BAN_TRONG_HO_SO",
    TONG_SO_VAN_BAN_TRONG_HO_SO: "TONG_SO_VAN_BAN_TRONG_HO_SO",
};
