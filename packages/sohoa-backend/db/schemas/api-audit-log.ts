...
export const apiAuditLogs = schema.table("api_audit_logs", {
    ...
    summaryKey: varchar("summary_key", { length: 100 }),
    summaryParams: jsonb("summary_params"),
...
export const apiAuditLogEntitySchema = t.Object({
    ...
    summaryKey: t.Optional(t.Union([t.String(), t.Null()])),
    summaryParams: t.Optional(t.Union([t.Record(t.String(), t.Any()), t.Null()])),
