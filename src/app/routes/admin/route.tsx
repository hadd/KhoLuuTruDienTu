...
import { adminPermissionNavItem } from '@/features/permissions/config/adminNavConfig'
...
function AdminLayout() {
    ...
    const PermissionIcon = adminPermissionNavItem.icon
        ...
        <div className="flex h-screen min-h-0 w-full overflow-hidden bg-background">
            ...
            >
                ...
                <nav className={cn(
                    ...
                    />
                    <AdminNavLink
                        to={adminPermissionNavItem.to}
                        label={t(adminPermissionNavItem.labelKey)}
                        icon={PermissionIcon}
                        collapsed={collapsed}
                    />
                </nav>
