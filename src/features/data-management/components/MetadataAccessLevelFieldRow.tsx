...
import { MetadataAccessLevelFieldSelect } from '@/features/data-management/components/MetadataAccessLevelFieldSelect'
...
export function MetadataAccessLevelFieldRow({
  field,
  value,
  disabled,
  onValueChange,
  ...
  return (
    ...
    >
      ...
      <div className="grid min-w-0 flex-1 gap-2 sm:grid-cols-[220px_minmax(0,1fr)] sm:items-start">
        ...
        <MetadataAccessLevelFieldSelect
          value={displayValue}
