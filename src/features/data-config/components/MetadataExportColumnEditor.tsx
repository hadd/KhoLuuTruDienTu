...
export function MetadataExportColumnEditor({
  ...
  // 1. Ánh xạ từ field key sang tên nhóm (groupName) để tra cứu nhanh
  ...
  // 2. Đếm số lần xuất hiện của các nhãn hiển thị trong danh mục để phát hiện trùng lặp
  ...
  // 3. Hàm lấy nhãn thông minh: tự động bổ sung tên nhóm nếu nhãn bị trùng lặp ở nhóm khác
  ...
  // 4. Hàm lấy danh sách nhóm của các trường trong cột để hiển thị cạnh tiêu đề "Cột X"
  ...
  // Xác định các trường chưa được gán vào cột nào
  ...
  const handleConvertUnselectedToColumns = () => {
    ...
    // Tạo cột mới và gán tiêu đề tự động bằng nhãn thông minh (có tên nhóm nếu trùng)
          ...
          >
            <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
              <p className="text-sm font-medium">
                ...
                {/* Hiển thị thêm thông tin nhóm của các trường có trong cột */}
                  ...
                  {column.fieldKeys.map((fieldKey, fieldIndex) => (
                    ...
                    >
                      <span className="truncate">
                        {/* Sử dụng nhãn thông minh để phân biệt trường trùng tên trong danh sách đã chọn */}
