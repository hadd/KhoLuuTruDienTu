...
export function GroupSetupDialog({ open, onOpenChange, group }: GroupSetupDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Thiết lập quản lý thành viên và hồ sơ cho nhóm <span className="font-semibold text-foreground">{group.name}</span>.
          </DialogDescription>
        </DialogHeader>
